	...
	render() {
		...
		return (
			<div>
				...
				<br></br>
				<h5 style={heading3Style}>
					Lorem ipsum dolor sit amet consectetur adipisicing elit.
					<br></br>
					Vero id nulla ab temporibus officia velit soluta ullam dicta.
				</h5>
				<div style={gridContainerStyle}>
					<div style={gridItemStyle}>
						<img src='/lets1.jpg' alt='Image 1' style={imageStyle} />
						<br></br>
					...
					<div style={gridItemStyle}>
						<img src='/lets2.jpg' alt='Image 2' style={imageStyle} />
						<br></br>
						<h3 style={textStyle}>Lorem ipsum</h3>
						<br></br>
						<span style={textStyle}>Lorem ipsum dolor sit amet consectetur, adipisicing...</span>
					...
					<div style={gridItemStyle}>
						<img src='/lets3.jpg' alt='Image 3' style={imageStyle} />
						<br></br>
						<h3 style={textStyle}>Lorem ipsum</h3>
						<br></br>
						<span style={textStyle}>Lorem ipsum dolor sit amet consectetur, adipisicing...</span>
				...
				<div style={buttonContainerStyle}>
					<button
						...
						onMouseLeave={e => {
							e.target.style.backgroundColor = '#4a4a49'
						}}>
						SHOW MORE
					</button>
				</div>
